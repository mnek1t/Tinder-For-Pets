...
namespace TinderForPets.Application.Services
{
    public class RecommendationService
    {
        ...
        public RecommendationService(IAnimalProfileRepository animalProfileRepository, ICacheService cacheService, S2GeometryService s2GeometryService, IMapper mapper)
        {
        ...
        public async Task<Result<List<AnimalProfileModel>>> GetRecommendationsForUserAsync(Guid userId, double radiusKm, CancellationToken cancellationToken) 
        {
            ...
            try
            {
                ...
                filter.NearbyS2CellIds.Add(animalProfile.S2CellId); // include profiles from the same s2 cell
